        ...
        m = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    if (!(o < 0 || o > s.globals.gridWidth)) {
                        if (null === t.x2) {
                            ...
                            var d = this.graphics.drawRect(o + t.offsetX, 0 + t.offsetY, h - o, s.globals.gridHeight + t.offsetY, 0, t.fillColor, t.opacity, 1, t.borderColor, r);
                ...
                value: function(t, e, i) {
                    ...
                    } else s = n.globals.gridHeight - (t.y - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight);
                    ...
                    if (null === t.y2) {
                        ...
                        } else a = n.globals.gridHeight - (t.y2 - n.globals.minYArr[t.yAxisIndex]) / (n.globals.yRange[t.yAxisIndex] / n.globals.gridHeight);
                        if (a > s) {
                            var g = s;
                            s = a, a = g
                        }
                ...
                value: function(t, e, i) {
                    ...
                    var P = E.bbox(),
                        T = this.graphics.drawRect(P.x - v, P.y - C, P.width + v + w, P.height + A + C, x, g, 1, f, m, p);
                    return E.before(T), e && z.globals.memory.methodsToExec.push({
                        context: L,
                        method: L.addText,
                        params: {
                            x: s,
                ...
                value: function(t, e, i) {
                    ...
                    if (x.attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), h.x instanceof Array)
                        for (var m = 0; m < h.x.length; m++) {
                            ...
                            if (s.globals.dataChanged)
                                if (this.dynamicAnim) {
                                    var z, M = s.config.chart.animations.dynamicAnimation.speed,
                                        ...
                                        P = void 0,
                                        T = void 0;
                                    null != (z = s.globals.previousPaths[l] && s.globals.previousPaths[l][e]) && (E = z.x, P = z.y, T = void 0 !== z.r ? z.r : y);
                            ...
                            r.setSelectionFilter(C, l, b), Y.addEvents(C), C.node.classList.add("apexcharts-marker"), x.add(C), d.add(x)
                        }
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    for (var o = 0, l = 0; o < t.length; o++, l++) {
                        ...
                        for (var L = s.group({
                            ...
                            var E, P = this.drawCandleStickPaths({
                                indexes: {
                                    i: o,
                                    j: z,
                                    realIndex: b,
                            ...
                            d = P.pathTo, u = P.pathFrom, p = P.y, g = P.x, E = P.color, z > 0 && m.push(g + k / 2), x.push(p);
                            var T = a.fillPath({
                                    seriesNumber: b,
                                    color: E
                                }),
                        ...
                        for (var c = 0, g = 0; g < t[o].length; g++) {
                            ...
                            if (e.globals.dataChanged) {
                                ...
                                if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                                    ...
                                    S || (S = "rgba(255, 255, 255, 0)"), this.animateHeatColor(w, d.isColorHex(S) ? S : d.rgb2hex(S), d.isColorHex(b) ? b : d.rgb2hex(b), A)
                                }
                            }
                ...
                value: function(t, e, i) {
                    ...
                    for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], m = [], b = 0, y = 0; y < t.length; y++) {
                        ...
                        var C = [],
                            ...
                            E = M;
                        M > s.globals.gridHeight && (E = s.globals.gridHeight), b = w / 2;
                        var P = s.globals.padHorizontal + b,
                            T = 1;
                        s.globals.isXNumeric && (P = (s.globals.seriesX[k][0] - s.globals.minX) / g), z.push(P);
                        var X = void 0,
                            Y = void 0,
                            I = void 0,
                            F = void 0,
                        ...
                        if (G = this.determineFirstPrevY({
                            ...
                            for (var q = 0; q < t[y].length; q++)
                                if (null !== t[y][q]) {
                                    _ = w * q, G = M - t[y][q] / c[this.yaxisIndex], X = a.move(_, G), Y = a.move(_, E);
                                    break
                                }
                        ...
                        for (var Z = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, $ = 0; $ < Z; $++) {
                            s.globals.isXNumeric ? P = (s.globals.seriesX[k][$ + 1] - s.globals.minX) / g : P += w;
                            var J = d.isNumber(s.globals.minYArr[k]) ? s.globals.minYArr[k] : s.globals.minY;
                            s.config.chart.stacked ? (j = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? m[y - 1][$ + 1] : M, T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? j - J / c[this.yaxisIndex] : j - t[y][$ + 1] / c[this.yaxisIndex]) : T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? M - J / c[this.yaxisIndex] : M - t[y][$ + 1] / c[this.yaxisIndex], z.push(P), C.push(T);
                            ...
                            N = Q.areaPaths, O = Q.linePaths, B = Q.pX, V = Q.pY, Y = Q.areaPath, X = Q.linePath, this.appendPathFrom && (I += a.line(P, M), F += a.line(P, M));
                            ...
                            if (this.pointsChart) this.scatter.draw(D, $, {
                                realIndex: k,
                                pointsPos: K,
                                zRatio: u,
                                elParent: R
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    if (y.show) {
                        ...
                        n.add(k), this.drawAxisTicks(w, o, y, e.config.yaxis[t].axisTicks, t, l, n)
                    }
                    return n
                }
            }, {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    if (s.config.xaxis.axisBorder.show) {
                        ...
                        n.add(m), new N(this.ctx).drawAxisTicks(0, o.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, n)
                    }
                    return n
                }
            }, {
        ...
        H = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (t === Number.MIN_VALUE && 0 === e || !d.isNumber(t) && !d.isNumber(e) || t === Number.MIN_VALUE && e === Number.MIN_SAFE_INTEGER) return t = 0, e = s, this.linearScale(t, e, s);
                ...
                value: function(t, e, i) {
                    ...
                    var u = Array(l.length).fill().map(function(t, e) {
                            return Number.MAX_SAFE_INTEGER
                        }),
                        g = Array(l.length).fill().map(function(t, e) {
        ...
        W = function() {
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && i !== Number.MAX_SAFE_INTEGER) {
                        var f = t.maxY - i;
                        i >= 0 && i <= 10 && (f = 0), t.minY = i - 5 * f / 100, console.log(t.maxY), t.maxY = t.maxY + 5 * f / 100 + .025
                    }
        ...
        V = function() {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    this.isBarHorizontal || this.setGridXPosForDualYAxis(n, s), new N(this.ctx).setYAxisXPosition(s, n)
                }
            }, {
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (e.globals.axisCharts) {
                        if ("back" === e.config.xaxis.crosshairs.position) new P(this.ctx).drawXCrosshairs();
                        if ("back" === e.config.yaxis[0].crosshairs.position) new P(this.ctx).drawYCrosshairs();
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (!(!e.config.plotOptions.bar.horizontal || "bar" !== e.config.chart.type)) {
                        ...
                        if (e.config.grid.yaxis.lines.show)
                            for (var z = 0, M = 0, E = e.globals.gridWidth, P = 0; P < n + 1; P++) {
                                var T = i.drawLine(0, z, E, M, e.config.grid.borderColor, s);
                    ...
                    case "A":
                        t = (e = function(t, e) {
                            var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, m, b, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]),
                                ...
                                O = new SVG.Point(Y, I),
                                N = [];
                            if (0 === M || 0 === E || F.x === O.x && F.y === O.y) return [
                                ["C", F.x, F.y, O.x, O.y, O.x, O.y]
                            ];
                            i = new SVG.Point((F.x - O.x) / 2, (F.y - O.y) / 2).transform((new SVG.Matrix).rotate(P)), (s = i.x * i.x / (M * M) + i.y * i.y / (E * E)) > 1 && (s = Math.sqrt(s), M *= s, E *= s);
                            a = (new SVG.Matrix).rotate(P).scale(1 / M, 1 / E).rotate(-P), F = F.transform(a), O = O.transform(a), n = [O.x - F.x, O.y - F.y], o = n[0] * n[0] + n[1] * n[1], r = Math.sqrt(o), n[0] /= r, n[1] /= r, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, T === X && (l *= -1);
                            ...
                            for (m[0][0] = m[0][1].clone(), m[m.length - 1][2] = m[m.length - 1][1].clone(), a = (new SVG.Matrix).rotate(P).scale(M, E).rotate(-P), k = 0, A = m.length; k < A; k++) m[k][0] = m[k][0].transform(a), m[k][1] = m[k][1].transform(a), m[k][2] = m[k][2].transform(a);
                            for (k = 1, A = m.length; k < A; k++) w = m[k - 1][2], S = w.x, C = w.y, w = m[k][0], L = w.x, z = w.y, w = m[k][1], Y = w.x, I = w.y, N.push(["C", S, C, L, z, Y, I]);
                            return N
                        }(this.pos, t))[0]
                }
