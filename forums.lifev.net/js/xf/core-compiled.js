...
! function(d, k, h) {
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
            ...
            adjustHtmlForRte: function(a) {
                ...
                a = a.replace(/([\w\W]|^)<a\s[^>]*data-user-id="\d+"\s+data-username="([^"]+)"[^>]*>([\w\W]+?)<\/a>/gi, function(a, c, d, f) {
        ...
        XF.create({
            ...
            isShortcutAllowed: function(a) {
                switch (a.tagName) {
                    ...
                    case "BODY":
                        return !0;
                    default:
                        return XF.browser.msie && d(a).parents(".fr-element").length ? !1 : "true" === a.contentEditable ?
                            !1 : !0
                }
            },
            ...
            function e(a) {
                ...
                b[0] !== c[0] || XF.isElementVisible(b) || (a = a.closest(".overlay-container.is-active"), a.length ? a.scrollTop(b.offset().top - a.offset().top + a.scrollTop() -
                    100) : (b[0].scrollIntoView(), k.scrollBy(0, -100)))
            }
            var f = {};
            return {
                initialize: function() {
            ...
            return {
                ...
                checkNotices: function() {
                    ...
                    d(h).find("footer.p-footer").css("margin-bottom",
                        a)
                }
            }
        }(), XF.Push = function() {
            ...
            function b() {
                XF.Push.serviceWorkerReg.pushManager.getSubscription().then(function(a) {
                    ...
                    XF.Push.isSubscribed ? (d(h).trigger("push:init-subscribed"), XF.config.userId && e(a) ? XF.Push.updateUserSubscription(a, "update") : (a.unsubscribe(),
                        XF.Push.updateUserSubscription(a, "unsubscribe"))) : d(h).trigger("push:init-unsubscribed")
                })
            }
            ...
            return {
                ...
                setPushHistoryUserIds: function(a) {
                    XF.LocalStorage.setJson("push_history_user_ids",
                        a || {})
                },
                    ...
                    if ("update" !== b || !XF.Cookie.get("push_subscription_updated")) {
                        ...
                        d.ajax({
                            ...
                            data: {
                                ...
                                token: e ? btoa(String.fromCharCode.apply(null,
                                    new Uint8Array(e))) : null,
                                encoding: f,
                        ...
                        var f, g = 0,
                            l = function() {
                                var c = b.scrollHeight,
                                    d = b.offsetHeight;
                                0 == c || 0 == d ? 2E3 < g || (f && (clearTimeout(f), g += 200), f = setTimeout(l, g)) : c > d + 1 ? a.addClass("is-expandable") : a.removeClass("is-expandable")
                            };
                        l();
...
! function(c, e, g, h) {
    ...
    XF.ShareInput = XF.Element.newHandler({
        ...
        success: function() {
            XF.flashMessage(this.options.successText ? this.options.successText : XF.phrase("text_copied_to_clipboard"), 3E3)
        },
        click: function(a) {
            c(a.target).select()
        }
        ...
        XF.Element.newHandler({
            ...
            init: function() {
                ...
                (new Clipboard(this.$target[0], {
                    ...
                    if (b.options.success) XF.flashMessage(b.options.success,
                        3E3);
                    else {
        ...
        actionComplete: function(a) {
            if (a.html) {
                ...
                XF.setupHtmlInsert(a.html, function(a, c, h) {
                    ...
                    f ? (b.addClass("has-reaction"), b.removeClass("reaction--imageHidden"), d && b.removeClass("reaction--" + d), b.addClass("reaction--" + f), b.data("reaction-id", f)) : (b.removeClass("has-reaction"), b.addClass("reaction--imageHidden"),
                        d && (b.removeClass("reaction--" + d), b.addClass("reaction--" + a.data("reaction-id")), b.data("reaction-id", 0)));
                    l.replaceWith(c);
                    m && h && m.replaceWith(h)
                });
    ...
    XF.BookmarkClick =
        XF.Event.newHandler({
            ...
            click: function(a) {
                if (!(0 < a.button || a.ctrlKey || a.shiftKey || a.metaKey ||
                        a.altKey))
            ...
            handleSwitchClick: function(a) {
                ...
                a.html ? XF.setupHtmlInsert(a.html, function(a, d, e) {
                    b.tooltip.requiresLoad() &&
                        (b.$tooltipHtml = a, b.tooltip.setLoadRequired(!1));
                    c()
                }) : c()
            },
            ...
            initializeTooltip: function(a) {
                a.find("form").on("ajax-submit:response",
...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function(c, g, d) {
    c instanceof String && (c = String(c));
    for (var a = c.length, b = 0; b < a; b++) {
        var e = c[b];
        if (g.call(d, e, b, c)) return {
            i: b,
            v: e
        }
    }
...
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(c, g, d) {
    c != Array.prototype && c != Object.prototype && (c[g] = d.value)
};
$jscomp.getGlobal = function(c) {
    return "undefined" != typeof window && window === c ? c : "undefined" != typeof global && null != global ? global : c
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(c, g, d, a) {
    if (g) {
        d = $jscomp.global;
        c = c.split(".");
        ...
        a = d[c];
        g = g(a);
        g != a && null != g && $jscomp.defineProperty(d, c, {
            configurable: !0,
            writable: !0,
            value: g
        })
...
$jscomp.polyfill("Array.prototype.values", function(c) {
    return c ? c : function() {
        return $jscomp.iteratorFromArray(this, function(c, d) {
            return d
        })
    }
}, "es8", "es3");
! function(c, g, d) {
        ...
        click: function(a) {
            ...
            if (b)
                if (f) {
                    ...
                    setTimeout(function() {
                        var a = {};
                        k ? a = b.closest(k).find("input, select, textarea").serializeArray() : a[b.attr("name")] = b.prop("checked") ? b.attr("value") : h;
                        XF.ajax("POST", f, a)
                    }, 0)
                } else c ? ((a = c.data("submit-click-timer")) && clearTimeout(a), c.one("ajax-submit:complete", function(a, c, e) {
    ...
    XF.AjaxSubmit = XF.Element.newHandler({
        ...
        submit: function(a) {
            var b = this.$submitButton,
                e = this.$target,
                f = "multipart/form-data" == e.attr("enctype");
            if (f) {
            ...
            if (!(this.$submitButton && this.$submitButton.data("prevent-ajax") || XF.debug.disableAjaxSubmit))
                if (this.submitPending) a && a.preventDefault();
                    ...
                    setTimeout(function() {
                        d.submitPending = !0;
                        var a = XF.getDefaultFormData(e, b, d.options.jsonName, d.options.jsonOptIn);
                        d.disableButtons();
                        XF.ajax(l.method, l.action, a, l.successCallback, l.ajaxOptions).always(function() {
                            d.$submitButton = null;
                            setTimeout(function() {
                                d.submitPending = !1;
                                d.enableButtons()
        ...
        submitResponse: function(a, b, e) {
            if ("object" != typeof a) XF.alert("Response was not JSON.");
            else {
                b = this.$target;
                e = this.$submitButton;
                var f = c.Event("ajax-submit:response");
                b.trigger(f, a, this);
                if (!f.isDefaultPrevented()) {
                    f = c.Event("ajax-submit:error");
                    var k = !1,
                        h = a.redirect && this.options.redirect,
                        d = b.closest(".overlay");
                    d.length && this.options.hideOverlay || (d = null);
                    h && this.options.skipOverlayRedirect && d && (h = !1);
                    e && e.attr("data-ajax-redirect") && (h = e.data("ajax-redirect"));
                    if (a.errorHtml) b.trigger(f, a,
                        this), f.isDefaultPrevented() || XF.setupHtmlInsert(a.errorHtml, function(a, b) {
                        b = b.h1 || b.title || XF.phrase("oops_we_ran_into_some_problems");
                        XF.overlayMessage(b, a)
                    }), k = !0;
                    else if (a.errors) b.trigger(f, a, this), f.isDefaultPrevented() || XF.alert(a.errors), k = !0;
                    ...
                    }) : XF.redirect(a.redirect) : XF.flashMessage(a.message, 3E3), d && d.trigger("overlay:hide");
                    else if (a.html) {
                        var g = this;
                        XF.setupHtmlInsert(a.html, function(a, b, c) {
                            if (g.options.replace && g.doSubmitReplace(a, c)) return !1;
                            d && d.trigger("overlay:hide");
                            a = XF.getOverlayHtml({
                                html: a,
                                title: b.h1 || b.title
                            });
                    ...
                    } else "ok" == a.status && (h && XF.redirect(a.redirect), d && d.trigger("overlay:hide"));
                    a.errors && f.isDefaultPrevented();
                    f = c.Event("ajax-submit:complete");
                    b.trigger(f, a, this);
                    f.isDefaultPrevented() || this.options.resetComplete && !k && b[0].reset()
                }
            }
        },
        doSubmitReplace: function(a, b) {
            var e = this.options.replace;
            if (!e) return !1;
            var f = e.split(" with ");
            e = c.trim(f[0]);
            f = f[1] ? c.trim(f[1]) : e;
            if ("self" == e || this.$target.is(e)) var d = this.$target;
            else d = this.$target.find(e).first(), d.length || (d = c(e).first());
            if (!d.length) return console.error("Could not find old selector '" + e + "'"), !1;
            var h = a.is(f) ? a : a.find(f).first();
            if (!h.length) return console.error("Could not find new selector '" + f + "'"), !1;
            this.options.showReplacement ? (h.hide().insertAfter(d), d.xfFadeUp(null, function() {
                d.remove();
                h.length && (XF.activate(h), b(!1));
                h.xfFadeDown(null, XF.layoutChange)
            })) : (h.insertAfter(d), d.remove(), h.length && (XF.activate(h), b(!1)), XF.layoutChange());
            return !0
        },
    ...
    XF.ChangeSubmit = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$target.find(".js-revert").on("click",
                XF.proxy(this, "revert"))
        },
        initForm: function() {
            this.formInitialized || (XF.Element.applyHandler(this.$target, "ajax-submit", {
                redirect: !1,
                forceFlashMessage: !1
        ...
        revert: function(a) {
            this.hasChanges && (this.$target.trigger("reset").trigger("submit"), this.hasChanges = !1)
        },
        complete: function(a) {}
    });
    XF.AutoComplete = XF.Element.newHandler({
        ...
        load: function() {
            ...
            "" == this.loadVal ? this.hideResults() : this.loadVal == a || this.loadVal.length < this.options.minLength || (b[this.options.queryKey] = this.loadVal,
                "" != this.options.extraFields && c(this.options.extraFields).each(function() {
    ...
    XF.AutoSubmit = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.options.progress && c(d).trigger("xf:action-start")
        }
    });
    ...
    XF.SelectPlus = XF.Element.newHandler({
        ...
        keydown: function(a) {
            "Shift" == a.key && XF.Keyboard.isShortcutAllowed(d.activeElement) && (this.isShifted = !0, this.redrawHover())
        },
        keyup: function(a) {
            "Shift" == a.key && this.isShifted && (this.isShifted = !1, this.redrawHover())
        },
        getShiftItems: function(a, b) {
            return null !== b && null !== this.lastSelected ? (a = a.slice(Math.min(b, this.lastSelected), Math.max(b,
                this.lastSelected) + 1), this.debug("shiftItems: %o", a), a) : c()
        },
        setActive: function(a) {
            var b = this.isActive;
            this.isActive = a ? !0 : 0 < this.$checkboxes.filter(":checked").length;
            this.deployMultiBar();
            this.isActive != b && (this.debug("setActive: %s", this.isActive), this.$target.trigger(this.isActive ? "selectplus:activate" : "selectplus:deactivate", [this]).toggleClassTransitioned(this.options.activeClass, this.isActive), c(d.body).toggleClassTransitioned("is-spDocTriggered", this.isActive))
        },
        redrawSelected: function() {
            ...
            this.$checkboxes.each(function(b) {
                var e = c(this),
                    f = e.is(":checked");
                b = a.$containers.eq(b);
                b.toggleClassTransitioned(a.options.checkedClass, f);
                e.data("check-state") != f && b.trigger("selectplus:toggle-item", [this, f]);
                e.data("check-state", f)
            })
        },
        redrawHover: function() {
            ...
            if (null !== this.lastSelected && null !== this.lastEntered && this.isShifted) {
                ...
                this.debug("redrawHover: lastSelected: %s, lastEntered: %s",
                    this.lastSelected, this.lastEntered);
        ...
        deployMultiBar: function() {
            if (this.isActive && this.options.spMultiBarUrl) {
                ...
                this.MultiBar && this.MultiBar.hide()
        },
        debug: function() {
        ...
        init: function() {
            ...
            a = {
                onSelect: function() {
                    ...
                    f.$target.val(a + "-" + (10 > c ? "0" + c : c) + "-" + (10 > b ? "0" + b : b))
                },
                onOpen: function() {
                    d.prop("readonly") && this.hide()
                },
                showTime: !1,
            ...
            c && (b = c.match(/^(\d{4})-(\d\d?)-(\d\d?)$/)) && (a.defaultDate = new Date(parseInt(b[1], 10), parseInt(b[2], 10) - 1, parseInt(b[3])), a.setDefaultDate = !0);
            this.picker = new Pikaday(a);
            this.$target.val(c);
            c = this.$target.parent().find(".js-dateTrigger");
    ...
    XF.DescLoader = XF.Element.newHandler({
        ...
        onLoad: function(a) {
            ...
            a.description ? XF.setupHtmlInsert(a.description, function(a, c, d) {
    ...
    XF.Disabler = XF.Element.newHandler({
        ...
        init: function() {
            ...
            if (a.is(":radio")) {
                var e = b,
                    f = a.attr("name");
                b.length || (e = c(d.body));
                e.on("click", 'input:radio[name="' + f + '"]', XF.proxy(this, "click"))
            } else if (a.is("option")) {
                var g = this;
            ...
            a.on("control:enabled control:disabled", XF.proxy(this,
                "recalculateAfter"));
        ...
        recalculate: function(a, b) {
            var e = this.$container,
                f = this.$target,
                d = e.find(this.options.controls).not(f),
                h = a ? 0 : XF.config.speed.fast,
                g = this,
                m = function() {
                    !b && g.options.autofocus && e.find("input:not([type=hidden], [type=file]), textarea, select, button").not(f).first().autofocus()
                };
            f.is(":enabled") && (f.is(":checked") && !this.options.invert || this.options.invert && !f.is(":checked")) ? (e.prop("disabled", !1).removeClass("is-disabled"), d.prop("disabled", !1).removeClass("is-disabled").each(function(a, b) {
                a = c(b);
                a.is("select.is-readonly") && a.prop("disabled", !0)
            }).trigger("control:enabled"), this.options.hide ? (a ? e.show() : e.slideDown(h, function() {
                XF.layoutChange();
                m()
            }), XF.layoutChange()) : a || m()) : (this.options.hide && (a ? e.hide() : e.slideUp(h, XF.layoutChange), XF.layoutChange()), e.prop("disabled", !0).addClass("is-disabled"), d.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(a, b) {
                a = c(b);
                b = a.data("disabled");
        ...
        create: function() {
            if (!this.created && (this.created = !0, 0 != this.options.remaining)) {
                ...
                if (this.options.incrementFormat) {
                    var b = new RegExp("^" + XF.regexQuote(a).replace("\\{counter\\}", "(\\d+)"));
    ...
    XF.FormSubmitRow = XF.Element.newHandler({
        ...
        update: function() {
            ...
            if (a < this.options.minWindowHeight) "normal" != this.state && (this.resetTarget(), this.state = "normal");
                ...
                var b = c(".js-bottomFixTarget").height() || 0;
                a = this.getScrollTop() + a - b;
                if (a >= this.elBottom) "normal" != this.state && (this.resetTarget(), this.state = "normal");
                else {
                    var d = this.containerTop + this.topOffset + this.fixElHeight;
                    a <=
                        d ? d >= this.elBottom || "absolute" == this.state || (a = this.$container.offset(), "stuck" == this.state ? (b = this.$fixEl.parent(), "static" == b.css("position") && (b = b.offsetParent())) : b = this.$fixEl.offsetParent(), b = b.offset(), this.$fixEl.css({
                            position: "absolute",
    ...
    XF.NumberBox = XF.Element.newHandler({
        ...
        step: function(a) {
            ...
            if (!b.prop("readonly"))
                ...
                } catch (f) {} else this.stepFallback(a)
        },
        stepFallback: function(a) {
            if (!this.$textInput.prop("readonly")) {
                ...
                if (Math.round(d) !== d) {
                    var m = 0;
                    c = c.split(".");
                    l ? m = c[1] ? c[1].length : 0 : Math.floor(h) !== h &&
                        (m = h.toString().split(".")[1].length || 0);
                    d = d.toFixed(m)
                }
                null !== a && d < a && (d = a);
                null !== g && d > g && (d = g);
        ...
        supportsStepFunctions: function() {
            ...
            return XF.browser.msie || a.prop("disabled") || a.prop("readonly") || this.$target.data("step") || "any" === a.attr("step") ? !1 : "function" === typeof a[0].stepUp && "function" === typeof a[0].stepDown
        }
    });
    ...
    XF.CheckboxSelectDisabler = XF.Element.newHandler({
        ...
        $checkboxes: null,
        init: function() {
            (this.$select = XF.findRelativeIf(this.options.select, this.$target)) && this.$select.length ? (this.$checkboxes = this.$target.find(":checkbox").on("click",
                XF.proxy(this, "update")), this.update()) : console.warn("No select element found using %s", this.options.select)
        },
        update: function() {
            var a = this.$select;
...
! function(d, h, k) {
        ...
        tabClick: function(a) {
            ...
            if (-1 == c) console.error("Did not find clicked element (%o) in tabs", b);
                ...
                if (!e.isDefaultPrevented()) {
                    ...
                    if (this.options.state) switch (a = h.location.href.split("#")[0], b.attr("id") ? (a = a + "#" + b.attr("id"), b = {
                        id: b.attr("id")
                    }) : b = {
                        offset: c
                    }, this.options.state) {
    ...
    XF.PageJump = XF.Element.newHandler({
        ...
        init: function() {
            var a = this;
            this.options.pageUrl ? (this.$input = XF.findRelativeIf(this.options.pageInput,
                this.$target), this.$input.length ? (this.$input.on("keyup", function(b) {
    ...
    XF.VideoInit = XF.Element.newHandler({
        ...
        loaded: !1,
        init: function() {
            XF.isIOS() && (this.video = this.$target[0].cloneNode(!0), this.video.load(),
                this.video.addEventListener("loadeddata", XF.proxy(this, "hasLoaded")), this.video.addEventListener("seeked", XF.proxy(this, "hasSeeked")))
        },
        hasLoaded: function() {
